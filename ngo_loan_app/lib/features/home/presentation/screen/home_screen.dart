...
import 'package:ngo_app/features/loan/presention/screens/medical/help/medical_help_apply.dart';
import 'package:ngo_app/features/loan_application/presentation/screen/complete_kyc_screen.dart';
            ...
            children: [
              ...
              Row(
                children: [
                  Expanded(
                    child: GestureDetector(
                      onTap: (){Get.to(const MedicalHelpApply());},
                      child: homeCard(
                        icon: loanIcon3,
